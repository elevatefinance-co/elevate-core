 ...
 * 2 / 2 Aug 2024) which dropped six insurance + commission Sections from 5 percent to 2 percent,
 * the Oct 2024 repeal of Section 194F, and the four staggered introductions (194Q from 1 July 2021,
 * 194R and 194S from 1 July 2022, 194BA from 1 April 2023, 194T from 1 April 2025).
 *
 * Primary sources:
...
describe('Oct 2024 cliff -- six Sections drop from 5 percent to 2 percent', () => {

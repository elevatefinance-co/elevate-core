 ...
 * and Section 50 separates 50(1) from 50(3) for the 18 percent vs 24 percent interest distinction.
...
describe('CGST_ACT_SECTIONS registry', () => {
  ...
  it('should pin Section 50 (interest) and distinguish 50(1) (18 percent) from 50(3) (24 percent)', () => {
  ...
  it('should pin demand-and-recovery Sections 73 and 74', () => {

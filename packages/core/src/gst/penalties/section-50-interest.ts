/* Section 50 of the CGST Act -- interest on delayed payment of tax. Two rates depending on the nature of
 * the lapse:
 *
 *   Section 50(1) -- 18 percent per annum on net cash tax liability for delayed payment
 *   Section 50(3) -- 24 percent per annum on ITC wrongly availed AND utilised
 *
...
export const SECTION_50_3_RATE_BASIS_POINTS = 2400;
...
export function computeSection50Interest(input: {
  ...
  const citations: Citation[] =
    input.kind === 'DELAYED_CASH_PAYMENT_S50_1'
      ...
      : [CGST_ACT_SECTIONS.SEC_50, CGST_ACT_SECTIONS.SEC_50_3];

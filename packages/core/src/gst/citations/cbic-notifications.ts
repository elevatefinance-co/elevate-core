...
export const CBIC_NOTIFICATIONS = {
  ...
  N_9_2022_CT: ct(
    '9/2022',
    '2022-07-05',
    'Brings the Finance Act 2022 Section 50(3) substitution into force retrospectively from 1 July 2017 -- interest only on ITC wrongly availed AND utilised, at the notified 18 percent rate',
  ),

  N_17_2024_CT: ct(
    '17/2024',
    '2024-09-27',
    'Appoints 1 November 2024 for Finance (No. 2) Act 2024 GST amendments, including the Section 17(5)(i) substitution and the new Section 74A demand regime',
  ),

  N_9_2025_CT_RATE: ctRate(
    '9/2025',
    '2025-09-17',
    'Rationalised CGST rate schedule per the 56th Council recommendations -- supersedes 1/2017-CT (Rate), effective 22 September 2025',
  ),
} as const;

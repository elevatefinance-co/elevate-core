...
export const CGST_RULES = {
  ...
  RULE_88B_1: rule(
    '88B',
    '1',
    'Interest under Section 50(1) on the net cash liability where the return is filed late, for the period of delay',
  ),
  RULE_88B_3: rule(
    '88B',
    '3',
    'Interest under Section 50(3) on ITC wrongly availed and utilised, from the date of utilisation to the date of reversal or payment',
  ),

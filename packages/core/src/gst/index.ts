 ...
 * notifications, GST Council meetings), the rate slab structure (effective-date banded -- five slabs to
 * 21 September 2025, the GST 2.0 two-rate-plus-de-merit structure thereafter), and the Section 17(5)
 * blocked-credit classifier. Place-of-supply resolvers (Sections 10-13 IGST), registration

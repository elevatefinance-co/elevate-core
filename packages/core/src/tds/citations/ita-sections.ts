...
export const ITA_SECTIONS = {
  ...
  SEC_194: ita(
    ...
    undefined,
    undefined,
    'TDS on dividends -- 10 percent above Rs 5,000 per shareholder per FY',
  ),
  SEC_194A: ita(
    '194A',
    undefined,
  ...
  SEC_194B: ita(
    ...
    undefined,
    undefined,
    'TDS on lottery / crossword / card-game winnings -- 30 percent above Rs 10,000',
  ),
  SEC_194BA: ita(
    '194BA',
    undefined,
  ...
  SEC_194BB: ita(
    ...
    undefined,
    undefined,
    'TDS on horse race winnings -- 30 percent above Rs 10,000',
  ),
  SEC_194C: ita(
    '194C',
    undefined,
  ...
  SEC_194D: ita(
    ...
    undefined,
    undefined,
    'TDS on insurance commission -- 2 percent post Oct 2024 (5 percent prior)',
  ),
  SEC_194DA: ita(
    '194DA',
    undefined,
  ...
  SEC_194I_A: ita(
    ...
    undefined,
    'a',
    'TDS on rent of plant / machinery / equipment -- 2 percent above Rs 2.4 lakh',
  ),
  SEC_194I_B: ita(
    '194I',
    undefined,
    'b',
    'TDS on rent of land / building / furniture -- 10 percent above Rs 2.4 lakh',
  ),
  SEC_194_IA: ita(
    '194-IA',
    undefined,
  ...
  SEC_194K: ita(
    ...
    undefined,
    undefined,
    'TDS on income from MF units -- 10 percent above Rs 5,000',
  ),
  SEC_194LA: ita(
    '194LA',
    undefined,
  ...
  SEC_206AB: ita(
    ...
    undefined,
    undefined,
    'Higher TDS for specified persons (non-filers of ITR with TDS / TCS >= Rs 50,000) -- max(2x, 5 percent)',
  ),
  ...
  SEC_206CCA: ita(
    ...
    undefined,
    undefined,
    'Higher TCS for specified persons (non-filers of ITR) -- max(2x, 5 percent)',
  ),

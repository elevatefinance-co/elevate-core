 ...
 *
 * For specified persons, TDS is at the higher of (a) twice the rate prescribed, (b) 5 percent. The 206AB
 * carve-outs cover Sections 192 / 192A / 194B / 194BB / 194LBC / 194N -- those are not subject to 206AB
 * uplift even for specified persons.
 *
...
import { isCarveOutFromS206AB, type TdsSectionKey } from '../rates/rate-band-resolver.js';
